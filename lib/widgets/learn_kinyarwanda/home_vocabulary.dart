...
class HomeVocabulary extends GetWidget<GameController> {
  HomeVocabulary({Key? key}) : super(key: key);
      ...
      () => SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                  "${controller.games2[controller.selectedUpIndex.value].text}",
              ...
              child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () {
                        if (controller.games[index].id !=
                            controller
                                .games2[controller.selectedUpIndex.value].id) {
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child:controller.games[index].image!.isEmpty?
                                  Text(
                  "${controller.games[index].textSub}",
                  style: TextAppStyles.titleBoldText)
                                  : SvgPicture.asset(
