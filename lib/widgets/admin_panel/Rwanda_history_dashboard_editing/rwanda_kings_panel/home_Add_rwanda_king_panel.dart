...
class HomeAddRwandaKingsPanel extends GetWidget<AdminPanelController> {
  HomeAddRwandaKingsPanel({Key? key}) : super(key: key);
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text("Add King", style: TextAppStyles.dashboardText),
                  ],
                ),
                SizedBox(
                              ...
                              style: ButtonStyle(
                                  ...
                                  backgroundColor:
                                      MaterialStateProperty.all<Color>(
                                          Colors.black)),
                              child: const Text('Add King'),
                              onPressed: () =>
                                  controller.submitRwandaKing(key: _formKey)),
                        ),
                      ),
              ],
            )),
