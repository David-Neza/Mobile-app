...
class HomeFoodPanel extends GetWidget<AdminPanelController> {
  const HomeFoodPanel({Key? key}) : super(key: key);
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () =>
                                Get.toNamed(RouteLinks.homeAddFoodPanel),
                            child: Text(
                              'Add Food',
                              style: TextStyle(
                                  fontFamily: 'Montserrat',
                            ...
                            itemBuilder: (context, index) {
                              return Padding(
                                ...
                                child: GestureDetector(
                                  onTap: () =>
                                      Get.toNamed(RouteLinks.homeFoodPanel),
                                  child: Container(
